...
bool AppInit(int argc, char* argv[])
{
    ...
    {
        fprintf(stderr,"\nError: Data directory %s needs to exist before calling aksyonchaind. Exiting...\n\n",mapArgs["-datadir"].c_str());
        delete mc_gState;
        return false;        
    }
    ...
    {
        fprintf(stderr,"\nError: Log directory %s needs to exist before calling aksyonchaind. Exiting...\n\n",mapArgs["-logdir"].c_str());
        return false;        
    }
...
*/
        ...
        (mc_gState->m_Params->NetworkName() == NULL))
    {
        ...
        {
            strUsage += "\n" + _("Usage:") + "\n" +
                  "  aksyonchaind <blockchain-name> [options]                     " + _("Start AksyonChain Core Daemon") + "\n";
